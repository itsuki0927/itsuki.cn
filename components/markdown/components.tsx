...
export const H2 = ({ children, ...rest }: StandardProps) => {
  ...
  return (
    <h2
      className="relative group mt-0 mb-8 text-3xl font-semibold"
      id={id}
      {...rest}
    >
      {children}
...
export const H3 = ({ children, ...rest }: StandardProps) => {
  ...
  return (
    <h3
      className="relative group mt-0 mb-6 text-2xl font-semibold"
      id={id}
      {...rest}
    >
      {children}
...
export const H4 = ({ children, ...rest }: StandardProps) => {
  ...
  return (
    <h4
      className="relative group mt-0 mb-6 text-xl font-semibold"
      id={id}
      {...rest}
    >
      {children}
...
export const Link = ({ href, children, ...rest }: LinkProps) => {
  ...
  return (
    <a
      className={isExternalLink ? styles.externalLink : styles.internalLink}
      href={href}
      {...rest}
    >
      {children}
